...
start "ASR Service" cmd /c "cd /d C:\Users\admin\OneDrive\Desktop\InsureBot\ASR && call ..\rasa_env\Scripts\activate && python main.py"
...
echo 📡 ASR Service: http://localhost:3001  
