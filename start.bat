...
start "System Initializer" cmd /c "cd /d C:\Users\admin\OneDrive\Desktop\InsureBot && call python system_initializer.py"

echo ⚙️ Starting Rasa Actions...
timeout /t 3 /nobreak >nul
start "Rasa Actions" cmd /c "cd /d C:\Users\admin\OneDrive\Desktop\InsureBot && call rasa run actions --port 5055"

echo 🤖 Starting Rasa Server...
timeout /t 5 /nobreak >nul
start "Rasa Server" cmd /c "cd /d C:\Users\admin\OneDrive\Desktop\InsureBot && call rasa run --enable-api --cors "*" --port 5005"
"
